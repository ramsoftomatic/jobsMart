       ...
       <!--  <li class="treeview">
        ...
        <li><a href="#"><i class="fa fa-circle-o text-red"></i> <span>Important</span></a></li> -->
         ...
         @if('upload-resume'== Request::path())
          ...
          <ul class="treeview-menu">
            <li><a href="upload-resume"><i class="fa fa-circle-o"></i>Upload</a></li>
            <li><a href="view-resume"><i class="fa fa-circle-o"></i>View</a></li>
          </ul>
        </li>
        @if('upload-csv'== Request::path())
        <li class="active ">
        @else
        <li class="">
        @endif
          <a href="upload-csv"><i class="fa fa-circle-o text-aqua"></i> <span>Upload .CSV file</span></a>
        </li>
